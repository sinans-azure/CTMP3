"""Authentication dependencies for trainer-service."""
...
def require_trainer(claims: Annotated[dict, Depends(get_current_user)]) -> dict:
    """Require the user to have the Trainer role."""
