"""Configuration for student-service using Pydantic Settings."""
...
class Settings(BaseSettings):
    """Student service configuration loaded from environment variables."""
    ...
    AZURE_STORAGE_QUEUE_NAME: str = "ec2-actions"
    AZURE_STORAGE_QUEUE_URL: str = ""  # e.g., https://<account>.queue.core.windows.net/
